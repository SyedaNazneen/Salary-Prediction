...
Developed by **Syeda Nazneen** *Data Scientist & NLP Engineer*

## 📝 Project Overview
This project demonstrates the end-to-end deployment of a Machine Learning model. It uses a **Simple Linear Regression** algorithm to predict salaries based on work experience. The backend is powered by **Flask**, and the frontend is built with modern **HTML5/CSS3**.
